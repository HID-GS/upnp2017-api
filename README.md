# upnptesting OpenAPI Specification
[![Build Status](https://travis-ci.org/HID-GS/upnp2017-api.svg?branch=master)](https://travis-ci.org/HID-GS/upnp2017-api)
...
6. If you did everything correct, https://hid-gs.github.io/upnp2017-api/ will lead to your new docs
...
- Documentation(ReDoc): https://hid-gs.github.io/upnp2017-api/
- SwaggerUI: https://hid-gs.github.io/upnp2017-api/swagger-ui/
- Look full spec:
    + JSON https://hid-gs.github.io/upnp2017-api/swagger.json
    + YAML https://hid-gs.github.io/upnp2017-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://hid-gs.github.io/upnp2017-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://hid-gs.github.io/upnp2017-api/ with url from the message: `Server started <url>`
